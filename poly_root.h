//downloaded this off the internet somewhere.
//The routine rpoly is the only routine needed.
//it gets the roots of a polynomial of arbitrary degree
...
//the *op is an array of coefficents, starting from the coefficient
//of the largest degree term and going down.  To be very clear,
//if the polynomial is 3x^3+2x^2+3, op should be [3,2,0,3].

//*zeror and *zeroi are the real and imaginary parts respectively of
//the roots.
