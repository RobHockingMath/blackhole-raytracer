...
while success!=0:
	...
	command="g++ -fopenmp -Ofast Main_4D_Menger_CrossSection_Chimera_Morph.cpp Shape.cpp Shape.h "\
	...
	+"Quaternion_Julia_Set.h Quaternion_Julia_Set.cpp Juliabulb.h Juliabulb.cpp Mandelbulb.h Mandelbulb.cpp -o " \
	+"Test"
