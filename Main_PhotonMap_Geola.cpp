...
//define a bunch of lights
	...
	#pragma omp parallel num_threads(numThreads)
    {
		...
		char* photon_map_0 = "Object_0_S.txt";
		char* photon_map_1 = "Object_1_S.txt";
		char* photon_map_2 = "Object_2_S.txt";
		char* photon_map_3 = "Object_3_S.txt";
		char* photon_map_4 = "Object_4_S.txt";
		char* photon_map_5 = "Object_5_S.txt";
		char* photon_map_6 = "Object_6_S.txt";
		char* photon_map_7 = "Object_7_S.txt";
		char* photon_map_8 = "Object_8_S.txt";
		char* photon_map_9 = "Object_9_S.txt";
...
//render world and write result to file
	...
	string filename_base = "./GeolaTests/";
...
try { 
	...
	//&&	!(2250<=i && i<=32315) && !(2500<=i && i<=2573) && !(2750<=i && i<=2839) && !(3000<=i && i<=3100) && !(3250<=i && i<=3369) && !(3500<=i && i<=3646) && !(3750<=i && i<=3899)){
		//if((i==2639)){
			...
			double bb2 = 1000;
			double radius2 = 0.75;
			PhotonMapLight *L2 = new spherePhotonMapLight(pos2, bb2,radius2, color2);
			
			double pos3[3]={-1,0,-3};
			int color3[3]={255,255,255};
			double bb3 = 500;
			double radius3 = 0.5;
			PhotonMapLight *L3 = new spherePhotonMapLight(pos3, bb3,radius3, color3);
			...
			Pinhole_Camera my_Camera(p_goala,l_goala,up_goala,F_goala);
			my_Camera.h_m=-3;
			my_Camera.h_M=3;
			...
			double black_hole_pos[3]={0.0,0,-3};
			...
			earth.addPhotonMapLight(L2);
			earth.addPhotonMapLight(L3);
